...
namespace Flexus.ParticleMapEditor.Editor
{
    ...
    public class VerletParticleGenerator : MonoBehaviour
    {
        ...
        public float AreaCoeffMin => Settings.AreaCoeffMin;
        public float AreaCoeffMax => Settings.AreaCoeffMax;
        public int Count => Settings.InitialCount;
        public float Damp => Settings.Damp;
        public bool IsUpdating => Settings.Update;
        public float AreaSize => Settings.AreaSize;
        public List<ParticleType> Types => Settings.Types;
        public int SubSteps => Settings.SubSteps;
        public int SpawnPerFrame => Settings.SpawnPerFrame;
        public Texture2D ParticleColors => Settings.ParticleColors;
        public Mesh Mesh => Settings.Mesh;
        public float CellSize => Settings.CellSize;
        public float RepaintTimeStep => Settings.RepaintTimeStep;
        public bool DrawResourses => Settings.DrawResourses;
        public float CameraDistance => Settings.CameraDistance;
        public float CameraRotationSpeed => Settings.CameraRotationSpeed;
        ...
        private IEnumerator Start()
        {
            foreach (var type in Types)
            {
                ...
                _typeMaterials[type] = new Material(Settings.ResMaterialSource);
        ...
        private void PaintParticle(Particle particle)
        {
            ...
            particle.Type = null;
            particle.Material = Settings.VoidMaterial;

            bool isNonResource = false;

            foreach (var args in Settings.NonResourceParticles)
            {
                if(color.CompareColorsWithTolerance(args.Color, Settings.ColorCompareTolerance))
                {
